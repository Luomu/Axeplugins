...
#include <string>
#include <map>
using namespace std; //who put this here?
#include <random>
...
namespace axeutils {
tr1::mt19937 mtwister(time(0));

double random(double low = 0.0, double high = 1.0);

// Return random line in a text file
CString randomLine(const CString& filename);
}
